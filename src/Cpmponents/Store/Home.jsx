  ...
  return (
      ...
      <div >
        <nav className="w-full h-[40px] fixed z-[2] flex justify-center items-center bg-gray-100 backdrop-blur-[2.5px] text-black-700 text-[12px] gap-[3.4em]">
          ...
          <a className="A" href="/mac">AirPods</a>
          <a className="A" href="/store">TV & Home</a>
          <a className="A" href="/mac">Entertainment</a>
          <a className="A" href="#/store">Accessories</a>
          <a className="A" href="/mac">Support</a>
