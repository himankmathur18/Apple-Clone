    ...
    return (
        <div id="Store">
            <div className=" bg-gray-100 flex ">
                <div className="storedata text-5xl font-bold text-left mt-[178px] ml-[80px]">
                    <p>
                        Store.
                        <span className="text-gray-500"> The best way to buy the products you love.</span>
                    </p>
                </div>
                <div className=" justify-right p-10 m-20">
                    <p className="flex"><img width="30" height="20" alt="" src="https://store.storeimages.cdn-apple.com/4668/as-images.apple.com/is/store-chat-specialist-icon-202309_AV3?wid=70&amp;hei=70&amp;fmt=jpeg&amp;qlt=90&amp;.v=1701194050300"></img>Need shoping help?</p><a href="https://www.apple.com/shop/buy" className=" text-blue-600 flex">Ask a Specialist<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width='10px' height='10px'><path fill="currentColor" d="M3.707 13.707L12 5.414V9a1 1 0 0 0 2 0V3a1 1 0 0 0-1-1v-.001H7a1 1 0 0 0 0 2h3.586l-8.293 8.293a.997.997 0 0 0 0 1.414a1 1 0 0 0 1.414 0z" /></svg></a>
                    <p className="flex"><svg width="25" height="35" viewBox="0 0 25 35" className="dd-glyph-svg dd-glyph-base" aria-hidden="true">
                    ...
                    </svg>Visit an Apple Store</p>
                    <a href="https://www.apple.com/shop/buy" className="text-blue-600 flex">  Find one near you<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width='1em' height='1em'><path fill="currentColor" d="M8.59 16.59L13.17 12L8.59 7.41L10 6l6 6l-6 6z" /></svg></a>
                </div>
            </div>
            <AppleProducts />
        </div>
